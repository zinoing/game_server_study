...
#define snprintf(dst, format, ...)		_snprintf_(dst.data(), dst.size(), _TRUNCATE, format, __VA_ARGS__)
#define snwprintf(dst, format, ...)		_snwprintf_(dst.data(), dst.size(), _TRUNCATE, format, __VA_ARGS__)
